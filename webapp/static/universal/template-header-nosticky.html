                        ...
                        <div class="panel panel-default sidebar-menu with-icons">
                            ...
                            <div class="panel-body">
                                <ul class="nav nav-pills nav-stacked">
                                    <li class="active"><a href="template-header-default.html">Default sticky header</a>
                                    </li>
                                    <li><a href="template-header-nosticky.html">No sticky header</a>
                                    </li>
                                    <li><a href="template-header-light.html">Light header</a>
                                    </li>
                                    <li><a href="template-header-ecommerce.html">E-commerce header</a>
                                    </li>
                            </div>
                        </div>
