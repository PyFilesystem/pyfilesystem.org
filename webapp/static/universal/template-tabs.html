                    ...
                    <div class="col-md-9">
                            ...
                            <div class="col-md-6">
                                <div class="tabs">
                                    <ul class="nav nav-tabs">
                                        <li class="active"><a href="#tab4-1" data-toggle="tab"><i class="icon-star"></i>First tab</a>
                                        </li>
                                        <li class=""><a href="#tab4-2" data-toggle="tab">Second tab</a>
                                        </li>
                                        <li><a href="#tab4-3" data-toggle="tab">Third tab</a>
                                        </li>
                                    </ul>
                            ...
                            <div class="col-md-6">
                                <div class="tabs">
                                    <ul class="nav nav-tabs nav-justified">
                                        <li class=""><a href="#tab5-1" data-toggle="tab"><i class="icon-star"></i>First tab</a>
                                        </li>
                                        <li class=""><a href="#tab5-2" data-toggle="tab">Second tab</a>
                                        </li>
                                        <li class="active"><a href="#tab5-3" data-toggle="tab">Third tab</a>
                                        </li>
                                    </ul>
                                    <div class="tab-content">
                        ...
                        <div class="tabs">
                            <ul class="nav nav-pills nav-justified">
                                <li class=""><a href="#tab2-1" data-toggle="tab">Web Design</a>
                                </li>
                                <li class=""><a href="#tab2-2" data-toggle="tab">Coding</a>
                                </li>
                                <li class="active"><a href="#tab2-3" data-toggle="tab">Consulting</a>
                                </li>
                            ...
                            <div class="tab-content tab-content-inverse">
                                ...
                                <div class="tab-pane" id="tab2-2">
                                    <p>
                                        ...
                                        enim craft beer mlkshk aliquip jean shorts ullamco ad vinyl cillum PBR. Homo nostrud organic, assumenda labore aesthetic magna delectus mollit. Keytar helvetica VHS salvia yr, vero magna velit sapiente labore stumptown.
                                        Vegan fanny pack odio cillum wes anderson 8-bit, sustainable jean shorts beard ut DIY ethical culpa terry richardson biodiesel. Art party scenester stumptown, tumblr butcher vero sint qui sapiente accusamus tattooed
                                        echo park.
                                    </p>
                                    <p>
                                        Raw denim you probably haven't heard of them jean shorts Austin. Nesciunt tofu stumptown aliqua, retro synth master cleanse. Mustache cliche tempor, williamsburg carles vegan helvetica. Reprehenderit butcher retro keffiyeh dreamcatcher synth. Cosby sweater
                                ...
                                <div class="tab-pane" id="tab2-4">
                                    <p>
                                        ...
                                        vinyl keffiyeh DIY salvia PBR, banh mi before they sold out farm-to-table VHS viral locavore cosby sweater. Lomo wolf viral, mustache readymade thundercats keffiyeh craft beer marfa ethical. Wolf salvia freegan,
