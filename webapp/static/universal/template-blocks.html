...
_________________________________________________________ -->
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <p class="lead">To divide information on the page - main information from secondary or one topic from another, the perfect way is to use our horizontal blocks. You can include in them texts, carousels, call to action elements etc.</p>
        ...
        <section class="bar background-image-fixed-2 no-mb color-white text-center">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="icon icon-lg text-center"><i class="fa fa-file-code-o"></i>
                        </div>
        ...
        <section class="bar background-pentagon no-mb">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h1>Block with pentagon background</h1>
        ...
        <section class="bar background-gray-dark no-mb color-white">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h1>Block with dark gray background</h1>
