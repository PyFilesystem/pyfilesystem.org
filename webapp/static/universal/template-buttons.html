...
_________________________________________________________ -->
 ...
 _________________________________________________________ -->
                        ...
                        <div class="col-md-9">
                            ...
                            <button type="button" class="btn btn-lg btn-template-main">Main button</button>
                            <br />
                            <button type="button" class="btn btn-template-main">Main button</button>
                            <br />
                            <button type="button" class="btn btn-sm btn-template-main">Main button</button>
                            <br />
                            <button type="button" class="btn btn-xs btn-template-main">Main button</button>
                            <br />
                            ...
                            <div class="bar background-dark-gray padding-horizontal margin-vertical">
                                <button type="button" class="btn btn-lg btn-template-transparent-primary">Transparent with primary</button>
                                <br />
                                <button type="button" class="btn btn-template-transparent-primary">Transparent with primary</button>
                                <br />
                                <button type="button" class="btn btn-sm btn-template-transparent-primary">Transparent with primary</button>
                                <br />
                                <button type="button" class="btn btn-xs btn-template-transparent-primary">Transparent with primary</button>
                                <br />
                                <hr>

                                <button type="button" class="btn btn-lg btn-template-transparent-black">Transparent with black</button>
                                <br />
                                <button type="button" class="btn btn-template-transparent-black">Transparent with black</button>
                                <br />
                                <button type="button" class="btn btn-sm btn-template-transparent-black">Transparent with black</button>
                                <br />
                                <button type="button" class="btn btn-xs btn-template-transparent-black">Transparent with black</button>
                                <br />
                            ...
                            <!-- Buttons template primary colour -->
                            <button type="button" class="btn btn-lg btn-template-primary">Primary colour button</button>
                            <br />
                            <button type="button" class="btn btn-template-primary">Primary colour button</button>
                            <br />
                            <button type="button" class="btn btn-sm btn-template-primary">Primary colour button</button>
                            <br />
                            <button type="button" class="btn btn-xs btn-template-primary">Primary colour button</button>
                            <br />
                            <hr>
                            ...
                            <button type="button" class="btn btn-xs btn-default">Button Default</button>
                            <hr>
                            <!-- Buttons style 2 -->
                            ...
                            <button type="button" class="btn btn-xs btn-primary">Button Primary</button>
                            <hr>
                            <!-- Buttons style 3 -->
                            ...
                            <button type="button" class="btn btn-xs btn-success">Button Success</button>
                            <hr>
                            <!-- Buttons style 4 -->
                            ...
                            <button type="button" class="btn btn-xs btn-info">Button Info</button>
                            <hr>
                            <!-- Buttons style 5 -->
                            ...
                            <button type="button" class="btn btn-xs btn-warning">Button Warning</button>
                            <hr>
                            <!-- Buttons style 6 -->
                            ...
                            <button type="button" class="btn btn-xs btn-danger">Button Danger</button>
                            <hr>
                            <!-- Buttons style 7 -->
                            ...
                            <button type="button" class="btn btn-xs btn-link">Button Link</button>
